      ...
      <div className="rating-container">
        ...
        <div className="rating">
          <form className="rating-form">
            <label htmlFor={`super-happy-${questionId}`}>
              <input
                type="radio"
                name={`rating-${questionId}`}
                className="super-happy"
                id={`super-happy-${questionId}`}
                value={1}
            ...
            <label htmlFor={`happy-${questionId}`}>
              <input
                type="radio"
                name={`rating-${questionId}`}
                className="happy"
            ...
            <label htmlFor={`neutral-${questionId}`}>
              <input
                type="radio"
                name={`rating-${questionId}`}
                className="neutral"
                id={`neutral-${questionId}`}
                value={3}
                onChange={handleRatingChange}
              />
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M8.5,11A1.5,1.5 0 0,1 7,9.5A1.5,1.5 0 0,1 8.5,8A1.5,1.5 0 0,1 10,9.5A1.5,1.5 0 0,1 8.5,11M15.5,11A1.5,1.5 0 0,1 14,9.5A1.5,1.5 0 0,1 15.5,8A1.5,1.5 0 0,1 17,9.5A1.5,1.5 0 0,1 15.5,11M12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M9,14H15A1,1 0 0,1 16,15A1,1 0 0,1 15,16H9A1,1 0 0,1 8,15A1,1 0 0,1 9,14Z" />
              </svg>
            </label>

            <label htmlFor={`sad-${questionId}`}>
              <input
                type="radio"
                name={`rating-${questionId}`}
                className="sad"
            ...
            <label htmlFor={`super-sad-${questionId}`}>
              <input
                type="radio"
                name={`rating-${questionId}`}
                className="super-sad"
                id={`super-sad-${questionId}`}
                value={5}
                onChange={handleRatingChange}
              />
              <svg viewBox="0 0 24 24">
